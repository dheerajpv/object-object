...
const languageEmojis = ["839517421748617256", "839517477963694111", "839517558071099402", "839518426694418482", "839517643237228584"];
...
export default {
    ...
    async callback({ message }) {
        let mainEmbed = new MessageEmbed()
            .setTitle("Languages")
            .setDescription("This embed will show you information on languages. Click its reaction to learn more.")
            .addFields(
                {
                    name: "JavaScript",
